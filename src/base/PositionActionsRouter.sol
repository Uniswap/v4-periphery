...
abstract contract PositionActionsRouter is BaseActionsRouter, DeltaResolver, Permit2ImmutableState {
    ...
    /**
     *
     * The following actions may change position state on v4 pool manager, and apply deltas.
     *
     */
    ...
    /**
     *
     * The following actions may resolve deltas on v4 pool manager. They wrap calls to the DeltaResolver contract.
     *
     */
    ...
    /// @notice Helper function for resolving open negative deltas (debts)
    /// @dev this is not a direct action, it is an implementation of the abstract function DeltaResolver._pay
    ...
    /**
     *
     * Sweep does not interact with v4 pool manager, but can be coupled at the end of a batch of the above actions to capture any remaining currencies in this contract.
     *
     */
    ...
    function _modifyLiquidity(
        ...
        bytes32 salt,
        bytes calldata hookData
    ) private returns (BalanceDelta liquidityDelta) {
