...
/// TODO: Does it need to be enforced?
contract Permit2Forwarder {
    ...
    function selfPermit(address owner, IAllowanceTransfer.PermitSingle calldata permitSingle, bytes calldata signature)
        external
    {
    ...
    function selfPermit(address owner, IAllowanceTransfer.PermitBatch calldata permitBatch, bytes calldata signature)
        external
    {
