...
contract RoutingTestHelpers is Test, Deployers {
    ...
    {
        return _finalizeAndExecuteSwap(inputCurrency, outputCurrency, amountIn, BalanceConsts.MSG_SENDER);
    }
        ...
        )
    {
        ...
        bytes memory data = plan.finalizeSwap(inputCurrency, outputCurrency, BalanceConsts.MSG_SENDER);
