...
contract RoutingTestHelpers is Test, Deployers {
    ...
    {
        return _finalizeAndExecuteSwap(inputCurrency, outputCurrency, amountIn, FlagConstants.MSG_SENDER);
    }
        ...
        )
    {
        ...
        bytes memory data = plan.finalizeSwap(inputCurrency, outputCurrency, FlagConstants.MSG_SENDER);
