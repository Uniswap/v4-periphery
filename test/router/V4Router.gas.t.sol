...
contract V4RouterTest is RoutingTestHelpers, GasSnapshot {
    ...
    function test_gas_swapExactIn_1Hop_zeroForOne() public {
        ...
        bytes memory data = plan.finalizeSwap(currency0, currency1, MSG_SENDER);
    ...
    function test_gas_swapExactIn_1Hop_oneForZero() public {
        ...
        plan = plan.add(Actions.SWAP_EXACT_IN, abi.encode(params));
        bytes memory data = plan.finalizeSwap(currency1, currency0, MSG_SENDER);
    ...
    function test_gas_swapExactIn_2Hops() public {
        ...
        plan = plan.add(Actions.SWAP_EXACT_IN, abi.encode(params));
        bytes memory data = plan.finalizeSwap(currency0, currency2, MSG_SENDER);
    ...
    function test_gas_swapExactIn_3Hops() public {
        ...
        plan = plan.add(Actions.SWAP_EXACT_IN, abi.encode(params));
        bytes memory data = plan.finalizeSwap(currency0, currency3, MSG_SENDER);
    ...
    function test_gas_nativeIn_swapExactInputSingle() public {
        ...
        plan = plan.add(Actions.SWAP_EXACT_IN_SINGLE, abi.encode(params));
        bytes memory data = plan.finalizeSwap(nativeKey.currency0, nativeKey.currency1, MSG_SENDER);
    ...
    function test_gas_nativeOut_swapExactInputSingle() public {
        ...
        plan = plan.add(Actions.SWAP_EXACT_IN_SINGLE, abi.encode(params));
        bytes memory data = plan.finalizeSwap(nativeKey.currency1, nativeKey.currency0, MSG_SENDER);
    ...
    function test_gas_nativeIn_swapExactIn_1Hop() public {
        ...
        plan = plan.add(Actions.SWAP_EXACT_IN, abi.encode(params));
        bytes memory data = plan.finalizeSwap(CurrencyLibrary.NATIVE, currency0, MSG_SENDER);
    ...
    function test_gas_nativeOut_swapExactIn_1Hop() public {
        ...
        plan = plan.add(Actions.SWAP_EXACT_IN, abi.encode(params));
        bytes memory data = plan.finalizeSwap(currency0, CurrencyLibrary.NATIVE, MSG_SENDER);
    ...
    function test_gas_nativeIn_swapExactIn_2Hops() public {
        ...
        plan = plan.add(Actions.SWAP_EXACT_IN, abi.encode(params));
        bytes memory data = plan.finalizeSwap(CurrencyLibrary.NATIVE, currency1, MSG_SENDER);
    ...
    function test_gas_nativeIn_swapExactIn_3Hops() public {
        ...
        plan = plan.add(Actions.SWAP_EXACT_IN, abi.encode(params));
        bytes memory data = plan.finalizeSwap(CurrencyLibrary.NATIVE, currency2, MSG_SENDER);
    ...
    function test_gas_nativeOut_swapExactOut_3Hops() public {
        ...
        plan = plan.add(Actions.SWAP_EXACT_OUT, abi.encode(params));
        bytes memory data = plan.finalizeSwap(currency2, CurrencyLibrary.NATIVE, MSG_SENDER);
