...
contract TestFullRange is Test, Deployers, GasSnapshot {
    ...
    function testBeforeInitializeAllowsPoolCreation() public {
        ...
        (,,,,,, address liquidityToken) = fullRange.poolToInfo(id);
    ...
    function testInitialAddLiquiditySucceeds() public {
        ...
        assertEq(UniswapV4ERC20(liquidityToken).balanceOf(address(this)), 100);
    }
    ...
    function testInitialAddLiquidityWithFeeSucceeds() public {
        ...
        (,,,,,, address liquidityToken) = fullRange.poolToInfo(feeId);
    ...
    function testAddLiquiditySucceedsWithNoFee() public {
        ...
        assertEq(UniswapV4ERC20(liquidityToken).balanceOf(address(this)), 150);
    }
    ...
    function testAddLiquidityWithDiffRatiosAndNoFee() public {
        ...
        assertEq(UniswapV4ERC20(liquidityToken).balanceOf(address(this)), 125);
    }
    ...
    function testSwapAddLiquiditySucceedsWithNoFee() public {
        ...
        assertEq(UniswapV4ERC20(liquidityToken).balanceOf(address(this)), 1000000000000000000);
    ...
    function testSwapAddLiquiditySucceedsWithFeeRebalance() public {
        ...
        assertEq(UniswapV4ERC20(liquidityToken).balanceOf(address(this)), 1 ether);
    ...
    function testInitialRemoveLiquiditySucceedsNoFee() public {
        ...
        assertEq(UniswapV4ERC20(liquidityToken).balanceOf(address(this)), 0);
    ...
    function testRemoveLiquiditySucceedsWithPartialAndFee() public {
        ...
        assertEq(UniswapV4ERC20(liquidityToken).balanceOf(address(this)), 50);
    ...
    function testRemoveLiquidityWithDiffRatiosAndNoFee() public {
        ...
        assertEq(UniswapV4ERC20(liquidityToken).balanceOf(address(this)), 75);
    }
    ...
    function testSwapRemoveLiquiditySucceedsWithFeeNoRebalance() public {
        ...
        assertEq(TestERC20(token1).balanceOf(address(this)), currBalance1 - 1000000000000000000 + 98 + 5000000 - 1);

        assertEq(UniswapV4ERC20(liquidityToken).balanceOf(address(this)), 1000000000000000000 - 5000000);
        ...
        assertEq(liquidity, 1000000000000000000 - 5000000);
        ...
        uint128 tokensOwed0New =
            uint128(FullMath.mulDiv(feeGrowthInside0LastX128 - 0, 1000000000000000000, FixedPoint128.Q128));

        uint128 tokensOwed1New =
            uint128(FullMath.mulDiv(feeGrowthInside1LastX128 - 0, 1000000000000000000, FixedPoint128.Q128));
    ...
    function testSwapRemoveLiquiditySucceedsWithFeeRebalance() public {
        ...
        assertEq(liquidity, 1 ether - 1); // it's actually less than the liquidity added LOL
