...
contract SwapAndAddForkSepoliaTest is Test {
    ...
    //  header: 50e6 USDC -> WETH through the real, TAPI-indexed
    // v4 USDC/WETH 0.01%/60 pool. The header matters: the API encodes v4 actions for the requested
    // router ABI generation, and this deployment's router is built from a v2.2-line UR revision —
    // calldata from older-version responses (the API default) uses the previous v4 action ABI and does
    // not decode on it. 2.1.1 and 2.2.0 responses encode v4 actions identically (verified byte-level),
    // so this fixture covers both. Bytes are the verbatim /v1/swap "data" tail (selector stripped):
    ...
    uint256 constant TAPI_FIXTURE_BLOCK = 11277442;
    bytes constant TAPI_EXECUTE_TAIL =
        hex"";
